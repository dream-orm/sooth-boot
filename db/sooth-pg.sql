...
-- ----------------------------
DROP TABLE IF EXISTS "public"."sys_base_class";
CREATE TABLE "public"."sys_base_class"
(
    "id" int8 NOT NULL,
...
;
COMMENT ON COLUMN "public"."sys_base_class"."id" IS 'id';
COMMENT ON COLUMN "public"."sys_base_class"."class_name" IS '基类全类名';
COMMENT ON COLUMN "public"."sys_base_class"."fields" IS '基类字段，多个用英文逗号分隔';
COMMENT ON COLUMN "public"."sys_base_class"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."sys_base_class"."update_time" IS '创建时间';
COMMENT ON COLUMN "public"."sys_base_class"."create_by" IS '创建人';
COMMENT ON COLUMN "public"."sys_base_class"."update_by" IS '更新人';
COMMENT ON TABLE "public"."sys_base_class" IS '基类管理';

-- ----------------------------
-- Records of sys_base_class
-- ----------------------------
INSERT INTO "public"."sys_base_class"
...
-- ----------------------------
INSERT INTO "public"."sys_button_permission"
...
-- ----------------------------
INSERT INTO "public"."sys_data_source"
...
VALUES (140960825093, '按钮权限', 'button_type', NULL, 0, 'admin', '2023-01-26 11:48:33', 'admin', '2023-01-26 14:57:05',
        0);
INSERT INTO "public"."sys_dict"
VALUES (270588795589, '运行状态', 'run_status', NULL, 0, 'admin', '2023-02-18 22:25:49.927', NULL, NULL, NULL);
INSERT INTO "public"."sys_dict"
...
INSERT INTO "public"."sys_dict"
VALUES (281647507141, '显示方式', 'show_type', NULL, 0, 'admin', '2023-02-20 22:25:42.293', NULL, NULL, NULL);
INSERT INTO "public"."sys_dict"
VALUES (281904125957, '校验方式', 'valid_type', NULL, 0, 'admin', '2023-02-20 23:32:31.967', NULL, NULL, NULL);
INSERT INTO "public"."sys_dict"
VALUES (287214592837, '控件类型', 'control_type', NULL, 0, 'admin', '2023-02-21 22:35:28.008', NULL, NULL, NULL);
INSERT INTO "public"."sys_dict"
VALUES (287229532613, '查询方式', 'search_type', NULL, 0, 'admin', '2023-02-21 22:39:21.447', NULL, NULL, NULL);
...
-- ----------------------------
DROP TABLE IF EXISTS "public"."sys_field_type";
CREATE TABLE "public"."sys_field_type"
(
    "id" int8 NOT NULL,
...
;
COMMENT ON COLUMN "public"."sys_field_type"."id" IS 'id';
COMMENT ON COLUMN "public"."sys_field_type"."column_type" IS '字段类型';
COMMENT ON COLUMN "public"."sys_field_type"."attr_type" IS '属性类型';
COMMENT ON TABLE "public"."sys_field_type" IS '字段类型管理';

-- ----------------------------
-- Records of sys_field_type
-- ----------------------------
INSERT INTO "public"."sys_field_type"
...
-- ----------------------------
DROP TABLE IF EXISTS "public"."sys_gen_field";
CREATE TABLE "public"."sys_gen_field"
(
    "id" int8 NOT NULL,
    "table_id" int8,
    ...
    "order_no" int4,
    "primary_pk" int2,
    "show_list_type" varchar(200) COLLATE "pg_catalog"."default",
    "valid_type"     varchar(200) COLLATE "pg_catalog"."default",
    "dict_code"      varchar(200) COLLATE "pg_catalog"."default",
    "show_edit_type" varchar(200) COLLATE "pg_catalog"."default",
    "control_type"   varchar(200) COLLATE "pg_catalog"."default",
    "search_type"    varchar(200) COLLATE "pg_catalog"."default"
)
;
COMMENT ON COLUMN "public"."sys_gen_field"."id" IS 'id';
COMMENT ON COLUMN "public"."sys_gen_field"."table_id" IS '表ID';
COMMENT ON COLUMN "public"."sys_gen_field"."column_name" IS '字段名称';
COMMENT ON COLUMN "public"."sys_gen_field"."column_type" IS '字段类型';
COMMENT ON COLUMN "public"."sys_gen_field"."column_comment" IS '字段说明';
COMMENT ON COLUMN "public"."sys_gen_field"."attr_name" IS '属性名';
COMMENT ON COLUMN "public"."sys_gen_field"."attr_type" IS '属性类型';
COMMENT ON COLUMN "public"."sys_gen_field"."order_no" IS '排序';
COMMENT ON COLUMN "public"."sys_gen_field"."primary_pk" IS '主键 0：否  1：是';
COMMENT ON COLUMN "public"."sys_gen_field"."show_list_type" IS '列表页显示方式';
COMMENT ON COLUMN "public"."sys_gen_field"."valid_type" IS '校验方式';
COMMENT ON COLUMN "public"."sys_gen_field"."dict_code" IS '字典';
COMMENT ON COLUMN "public"."sys_gen_field"."show_edit_type" IS '编辑页显示方式';
COMMENT ON COLUMN "public"."sys_gen_field"."control_type" IS '控件类型';
COMMENT ON COLUMN "public"."sys_gen_field"."search_type" IS '查询方式';
COMMENT ON TABLE "public"."sys_gen_field" IS '代码生成表字段';

-- ----------------------------
-- Records of sys_gen_field
-- ----------------------------
INSERT INTO "public"."sys_gen_field"
...
-- ----------------------------
DROP TABLE IF EXISTS "public"."sys_gen_group";
CREATE TABLE "public"."sys_gen_group"
(
    "id" int8 NOT NULL,
    "name" varchar(200) COLLATE "pg_catalog"."default"
)
;
COMMENT ON COLUMN "public"."sys_gen_group"."id" IS 'id';
COMMENT ON COLUMN "public"."sys_gen_group"."name" IS '表名';
COMMENT ON TABLE "public"."sys_gen_group" IS '模板配置组';

-- ----------------------------
-- Records of sys_gen_group
-- ----------------------------
INSERT INTO "public"."sys_gen_group"
...
;
COMMENT ON COLUMN "public"."sys_gen_table"."id" IS 'id';
COMMENT ON COLUMN "public"."sys_gen_table"."table_name" IS '表名';
COMMENT ON COLUMN "public"."sys_gen_table"."class_name" IS '类名';
COMMENT ON COLUMN "public"."sys_gen_table"."table_comment" IS '说明';
COMMENT ON COLUMN "public"."sys_gen_table"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."sys_gen_table"."update_time" IS '创建时间';
COMMENT ON COLUMN "public"."sys_gen_table"."create_by" IS '创建人';
COMMENT ON COLUMN "public"."sys_gen_table"."update_by" IS '更新人';
COMMENT ON TABLE "public"."sys_gen_table" IS '代码生成表';

-- ----------------------------
-- Records of sys_gen_table
-- ----------------------------
INSERT INTO "public"."sys_gen_table"
...
INSERT INTO "public"."sys_gen_table"
VALUES (274868828933, 'sys_quartz', 'SysQuartz', '定时任务', '2023-02-19 17:00:25.451', NULL, 'admin', NULL);
INSERT INTO "public"."sys_gen_table"
VALUES (287265330309, 'gen_table_field', 'GenTableField', '代码生成表字段', '2023-02-21 22:48:40.782', NULL, 'admin', NULL);

-- ----------------------------
-- Table structure for sys_gen_template
-- ----------------------------
DROP TABLE IF EXISTS "public"."sys_gen_template";
CREATE TABLE "public"."sys_gen_template"
(
    "id" int8 NOT NULL,
    "name"        varchar(200) COLLATE "pg_catalog"."default",
...
;
COMMENT ON COLUMN "public"."sys_gen_template"."id" IS 'id';
COMMENT ON COLUMN "public"."sys_gen_template"."name" IS '模板名称';
COMMENT ON COLUMN "public"."sys_gen_template"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."sys_gen_template"."update_by" IS '更新人登录名称';
COMMENT ON COLUMN "public"."sys_gen_template"."update_time" IS '更新日期';
COMMENT ON COLUMN "public"."sys_gen_template"."create_by" IS '创建人登录名称';
COMMENT ON COLUMN "public"."sys_gen_template"."group_id" IS '分组id';
COMMENT ON COLUMN "public"."sys_gen_template"."file_name" IS '模板文件名';
COMMENT ON TABLE "public"."sys_gen_template" IS '模板配置';

-- ----------------------------
-- Records of sys_gen_template
-- ----------------------------
INSERT INTO "public"."sys_gen_template"
VALUES (192578414789, '查询条件接受类', 'package ${packageName}.${moduleName}.${entityName}.model;
...
INSERT INTO "public"."sys_gen_template"
VALUES (192608309829, '接口服务类', 'package ${packageName}.${moduleName}.${entityName}.service;
...
INSERT INTO "public"."sys_gen_template"
VALUES (192619070789, '接口实现类', 'package ${packageName}.${moduleName}.${entityName}.service.impl;
...
INSERT INTO "public"."sys_gen_template"
VALUES (192633866053, '视图控制类', 'package ${packageName}.${moduleName}.${entityName}.service.impl;
...
INSERT INTO "public"."sys_gen_template"
VALUES (192662837189, 'api请求页', 'import { BaseApi } from ''/@/api/base/baseApi'';
...
INSERT INTO "public"."sys_gen_template"
VALUES (192688658309, '列表页', '<template>
  <div>
...
INSERT INTO "public"."sys_gen_template"
VALUES (192702147397, '弹窗页', '<template>
...
INSERT INTO "public"."sys_gen_template"
VALUES (192707297157, '数据页', 'import { BasicColumn } from ''/@/components/Table'';
...
INSERT INTO "public"."sys_gen_template"
VALUES (192596589061, '列表视图', 'package ${packageName}.${moduleName}.${entityName}.view;
...
}', '2023-02-04 19:55:22', 'admin', '2023-02-21 22:46:59.084', 'admin', 82324589637, '${className}LV.java');
INSERT INTO "public"."sys_gen_template"
VALUES (192034258629, '编辑视图', 'package ${packageName}.${moduleName}.${entityName}.table;
...
}', '2023-02-04 17:28:55', 'admin', '2023-02-21 22:47:32.811', 'admin', 82324589637, '${className}EV.java');
INSERT INTO "public"."sys_gen_template"
VALUES (362832993636357, '数据库表java类映射', 'package ${packageName}.${moduleName}.${entityName}.table;
...
VALUES (8, 15, '数据字典', '/basic/dict', 'basic/dict/index', NULL, 1, 1, 0, 'ant-design:hdd-twotone', 0, 0, NULL, 'admin',
        '2021-09-17 16:31:27', 'admin', '2023-02-18 21:11:09.124', 0, 1, 'basic-dict');
INSERT INTO "public"."sys_menu"
...
VALUES (270244951749, 15, '定时任务', '/basic/quartz', 'basic/quartz/index', NULL, 1, 3, 0,
        'ant-design:field-time-outlined', 0, 0, NULL, 'admin', '2023-02-18 20:56:17.361', 'admin',
        '2023-02-18 21:23:51.318', 0, 0, 'quartz');
INSERT INTO "public"."sys_menu"
VALUES (6, NULL, 'Dashboard', '/dashboard', 'layouts/default/index', '/dashboard/home', 0, 1, 0, 'ion:grid-outline', 0,
        0, NULL, 'admin', '2021-09-15 19:51:23', 'admin', '2023-02-19 16:54:30.811', 0, 0, 'dashboard');
...
-- ----------------------------
INSERT INTO "public"."sys_quartz"
VALUES (275051435013, 'admin', '2023-02-19 17:47:58.656', 0, 'admin', '2023-02-19 21:57:33.384', 'testJob',
        '* * * * * ? *', '{''type'':''A''}', '测试任务');
...
VALUES (1, 'admin', '管理员', '$2a$10$GK123CZgMaU2HQXFJGM46Or3EcQyZktQm6xeN1rR548Zvb/KA6QPG', '', 0, '', 0, NULL,
        '2019-06-21 17:54:10', 'admin', '2023-02-19 16:48:22.414');
...
-- ----------------------------
ALTER TABLE "public"."sys_base_class"
    ADD CONSTRAINT "gen_base_class_pkey" PRIMARY KEY ("id");
...
-- ----------------------------
ALTER TABLE "public"."sys_button_permission"
    ADD CONSTRAINT "sys_button_permission_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_data_permission
-- ----------------------------
ALTER TABLE "public"."sys_data_permission"
    ADD CONSTRAINT "sys_data_permission_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_data_source
-- ----------------------------
ALTER TABLE "public"."sys_data_source"
    ADD CONSTRAINT "sys_data_source_pkey" PRIMARY KEY ("id");
...
-- ----------------------------
ALTER TABLE "public"."sys_field_type"
    ADD CONSTRAINT "gen_field_type_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_gen_field
-- ----------------------------
ALTER TABLE "public"."sys_gen_field"
    ADD CONSTRAINT "gen_table_field_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_gen_group
-- ----------------------------
ALTER TABLE "public"."sys_gen_group"
    ADD CONSTRAINT "gen_template_group_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_gen_table
-- ----------------------------
ALTER TABLE "public"."sys_gen_table"
    ADD CONSTRAINT "gen_table_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_gen_template
-- ----------------------------
ALTER TABLE "public"."sys_gen_template"
    ADD CONSTRAINT "gen_template_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_interface_permission
-- ----------------------------
ALTER TABLE "public"."sys_interface_permission"
    ADD CONSTRAINT "sys_interface_permission_pkey" PRIMARY KEY ("id");
...
-- ----------------------------
ALTER TABLE "public"."sys_quartz"
    ADD CONSTRAINT "sys_quartz_job_pkey" PRIMARY KEY ("id");
...
ALTER TABLE "public"."sys_user_dept"
    ADD CONSTRAINT "sys_user_dept_pkey" PRIMARY KEY ("id");
