...
import com.moxa.sooth.core.base.common.system.util.JeecgDataAutorUtils;
...
public class PermissionDataAspect {
    ...
    @Pointcut("@annotation(com.moxa.sooth.core.base.common.aspect.annotation.PermissionData)")
