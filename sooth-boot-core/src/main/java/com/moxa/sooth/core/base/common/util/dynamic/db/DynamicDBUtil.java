...
import com.moxa.sooth.core.base.common.system.vo.DynamicDataSourceModel;
import com.moxa.sooth.core.base.common.util.ReflectHelper;
    ...
    public static DruidDataSource getDbSourceByDbKey(final String dbKey) {
        ...
        if (cacheDbSource != null && !cacheDbSource.isClosed()) {
            ...
            if (dataSource != null && dataSource.isEnable()) {
                ...
                throw new SoothBootException("动态数据源连接失败，dbKey：" + dbKey);
            }
