...
<script lang="ts">
  ...
  import { RadioGroup, Radio, CheckboxGroup, Checkbox, Select, InputNumber } from 'ant-design-vue';
  ...
  export default defineComponent({
    name: 'WeekUI',
    components: { RadioGroup, Radio, CheckboxGroup, Checkbox, Select, InputNumber },
    props: useTabProps({
      defaultValue: '?',
      props: {
