package com.moxa.sooth.module.base.interfacePermission.service.impl;
...
import com.moxa.sooth.module.base.interfacePermission.mapper.SysInterfacePermissionMapper;
...
public class SysInterfacePermissionServiceImpl extends ServiceImpl<SysInterfacePermission, SysInterfacePermission> implements ISysInterfacePermissionService {
    ...
    public List<Map<String, Object>> listInterfacePermissionTree() {
        Map<String, List<AppMapping>> groupMap = AppRunner.APP_MAPPING.values().stream().collect(Collectors.groupingBy(AppMapping::getBizModule));
