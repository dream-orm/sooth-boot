...
import com.moxa.sooth.modules.system.model.SysPermissionTree;
import com.moxa.sooth.modules.system.model.TreeModel;
import com.moxa.sooth.modules.system.service.*;
import com.moxa.sooth.modules.system.util.PermissionDataUtil;
...
//	}
    ...
    public Result<?> getUserPermissionByToken(HttpServletRequest request) {
        ...
        try {
            ...
            json.put("sysSafeMode", soothBootConfig.getSafeMode());
    ...
    public Result<?> getPermCode() {
        try {
            ...
            // 系统安全模式
            result.put("sysSafeMode", soothBootConfig.getSafeMode());
