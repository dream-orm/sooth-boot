...
import com.moxa.sooth.core.base.common.constant.FillRuleConstant;
...
import com.moxa.sooth.modules.system.mapper.SysCategoryMapper;
    ...
    public List<TreeSelectModel> queryListByCode(String pcode) throws SoothBootException {
        ...
        if (oConvertUtils.isNotEmpty(pcode)) {
            ...
            if (list == null || list.size() == 0) {
                throw new SoothBootException("该编码【" + pcode + "】不存在，请核实!");
            }
            if (list.size() > 1) {
                throw new SoothBootException("该编码【" + pcode + "】存在多个，请核实!");
            }
