...
import com.moxa.sooth.core.base.common.system.vo.DictModelMany;
...
public interface SysDictMapper extends BaseMapper<SysDict> {
     ...
     * @return
     */
    public String queryDictTextByKey(@Param("code") String code, @Param("key") Object key);
     ...
     * @return String
     */
    public String queryTableDictTextByKey(@Param("table") String table, @Param("text") String text, @Param("code") String code, @Param("key") Object key);
