...
import com.moxa.sooth.modules.system.service.ISysRoleIndexService;
...
public class SysRoleIndexController extends SoothController<SysRoleIndex, ISysRoleIndexService> {
    @Autowired
