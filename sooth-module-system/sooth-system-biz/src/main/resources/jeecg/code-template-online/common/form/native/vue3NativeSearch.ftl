        ...
        <a-col :lg="8">
            ...
            <a-form-item label="${po.filedComment}">
                ...
                <#elseif po.classType=='sel_user'>
                    <#if query_field_no gt 1>  </#if>
                    <j-select-user-by-dept placeholder="请选择${po.filedComment}"
                ...
                <#elseif po.classType=='list_multi'>
                    <#if query_field_no gt 1>  </#if>
                    <j-select-multiple placeholder="请选择${po.filedComment}"
...
<#elseif po.classType=='popup'>
                ...
                <#--  ---------------------------下拉或是单选 判断数据字典是表字典还是普通字典------------------------------- -->
                    <#if po.dictTable?default("")?trim?length gt 1>
                        <#if query_field_no gt 1>  </#if>
                        <j-dict-select-tag placeholder="请选择${po.filedComment}"
                                           v-model:value="queryParam.${po.fieldName}"
                    ...
                    <#else>
                        ...
                        <a-input placeholder="请输入${po.filedComment}"
                                 v-model:value="queryParam.${po.fieldName}"></a-input>
                    </#if>
                <#else>
                    <#if query_field_no gt 1>  </#if>
                    <a-input placeholder="请输入${po.filedComment}"
